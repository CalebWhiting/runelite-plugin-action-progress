...
public interface Fletching {
    ...
    @Generated("com/github/calebwhiting/runelite/data/DataVerify")
    int[] UNENCHANTED_BOLTS_AND_ARROWS = {
            ...
            ItemID.RUBY_BOLTS,
            ItemID.DIAMOND_BOLTS,
            ItemID.DRAGONSTONE_BOLTS,
            ItemID.ONYX_BOLTS,
            ItemID.KEBBIT_BOLTS,
            ItemID.DRAGON_ARROW,
            ItemID.BRONZE_ARROW_11700,
            ItemID.IRON_ARROW_11701,
            ItemID.STEEL_ARROW_11702,
            ItemID.MITHRIL_ARROW_11703,
            ItemID.BROAD_BOLTS,
            ItemID.ADAMANT_ARROW_20388,
            ItemID.DRAGON_ARROW_20389,
            ItemID.RUNE_ARROW_20600,
    ...
    @Generated("com/github/calebwhiting/runelite/data/DataVerify")
    int[] BOLT_TIPS = {
            ItemID.OPAL_BOLT_TIPS,
            ItemID.PEARL_BOLT_TIPS,
            ItemID.JADE_BOLT_TIPS,
            ItemID.TOPAZ_BOLT_TIPS,
            ItemID.SAPPHIRE_BOLT_TIPS,
            ItemID.EMERALD_BOLT_TIPS,
            ItemID.RUBY_BOLT_TIPS,
            ItemID.DIAMOND_BOLT_TIPS,

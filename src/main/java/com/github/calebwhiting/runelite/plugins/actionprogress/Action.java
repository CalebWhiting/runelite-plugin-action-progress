...
public enum Action {
    ...
    FLETCH_CUT_TIPS("Cutting", ActionProgressConfig::fletchArrowsAndBolts, ActionIcon.SPRITE_CRAFTING, 5),
    ...
    Action(String description, Function<ActionProgressConfig, Boolean> enabledFunction, IconSource iconSource, int tickTime0, int... otherTickTimes) {
